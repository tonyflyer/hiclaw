...
**CRITICAL**: Any change affecting built image content (modifications under `manager/`, `worker/`, or `openclaw-base/`) **must** be recorded in `changelog/current.md` before committing.
